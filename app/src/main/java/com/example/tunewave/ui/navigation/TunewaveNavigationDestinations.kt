...
sealed class TunewaveNavigationDestinations(val route: String) {
    object SearchScreen :
        TunewaveNavigationDestinations("MusifyNavigationDestinations.SearchScreen")

    object ArtistDetailScreen :
        TunewaveNavigationDestinations("MusifyNavigationDestinations.ArtistDetailScreen/{artistId}/{artistName}?encodedUrlString={encodedImageUrlString}") {
    ...
    object AlbumDetailScreen :
        TunewaveNavigationDestinations("MusifyNavigationDestinations.AlbumDetailScreen/{albumId}/{albumName}/{artistsString}/{yearOfReleaseString}/{encodedImageUrlString}") {
    ...
    object PlaylistDetailScreen :
        TunewaveNavigationDestinations(
    ...
    object HomeScreen : TunewaveNavigationDestinations("MusifyNavigationDestinations.HomeScreen")
    ...
    object PodcastShowDetailScreen : TunewaveNavigationDestinations(
